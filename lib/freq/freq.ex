defmodule Freq do
  ...
  # Key is a grapheme, value is number of occurrences for that grapheme in some text.
  ...
  def main(_args) do
    case Files.read_input_text() do
      ...
      raw_text ->
        ...
        calculate_total(graphemes)
        |> calculate_fraction(length(graphemes))
  ...
  defp calculate_total(graphemes) do
  ...
  @spec calculate_fraction(count_map(), integer()) :: FractionMap.t()
  defp calculate_fraction(frequency_map, total_count) do
